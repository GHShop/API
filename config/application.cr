...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Gh Shop web application."
  #
  #
  ...
  #
  # settings.secret_key_base= ONXQFTMx_asJgqeXtfbVIHMzfQnYDwD1tbV1MAaryLo
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("gh_shop.log", "w"))
  #
  #
end
